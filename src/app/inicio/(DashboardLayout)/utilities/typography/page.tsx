...
import DashboardCard from '@/app/inicio/(DashboardLayout)/components/shared/DashboardCard';
import BlankCard from '@/app/inicio/(DashboardLayout)/components/shared/BlankCard';
